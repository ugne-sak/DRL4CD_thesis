from functions.synthetic.noise_scale import init_noise_dist
from functions.synthetic.utils import sample_recursive_scm
from functions.synthetic.abstract import MechanismModel
import numpy as np
...
class LinearAdditive(MechanismModel):
    ...
    def __call__(self, rng, g, n_observations_obs, n_observations_int):
        ...
        W_matrix = np.zeros_like(g, dtype=float)
        b_vec = np.zeros([n_vars,1])
